...
3. 한국어 원문을 가린 상태에서 영어 초안을 직접 씁니다.
4. 최대 세 가지 핵심 피드백만 확인하고 한 번 다시 씁니다.
5. 재작성 후 문법 교정본, 자연스러운 회화체, 모범 답안, IH→AL 확장을 비교합니다.
6. 마지막에는 답안을 모두 가리고 말하기 타이머로 연습합니다.
